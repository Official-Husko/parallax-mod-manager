...
export namespace app {
	...
	export class EditInfo {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.LastSavedAt = source["LastSavedAt"];
	        this.MaxHistoryCount = source["MaxHistoryCount"];
	        this.FolderName = source["FolderName"];
	        this.VersionBump = this.convertValues(source["VersionBump"], modedit.VersionBumpSuggestion);
	    }
...
export namespace modedit {
	...
	export class Version {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.HadPatch = source["HadPatch"];
	    }
	}
	export class VersionBumpSuggestion {
	    Options: Record<string, Version>;
	    Suggested: string;
	    Reason: string;
	
	    static createFrom(source: any = {}) {
	        return new VersionBumpSuggestion(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.Options = this.convertValues(source["Options"], Version, true);
